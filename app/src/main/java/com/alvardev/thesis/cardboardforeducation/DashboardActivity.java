package com.alvardev.thesis.cardboardforeducation;
...
public class DashboardActivity extends CardboardActivity implements CardboardView.StereoRenderer{
    ...
    public void onSurfaceCreated(EGLConfig config) {
        ...
        mCubeVertices.put(WorldLayoutData.CUBE_COORDS);
        mCubeVertices.position(0);

        ByteBuffer bbColors = ByteBuffer.allocateDirect(WorldLayoutData.CUBE_COLORS.length * 4);
        bbColors.order(ByteOrder.nativeOrder());
        mCubeColors = bbColors.asFloatBuffer();
        mCubeColors.put(WorldLayoutData.CUBE_COLORS);
        ...
        mCubeFoundColors.put(WorldLayoutData.CUBE_FOUND_COLORS);
        mCubeFoundColors.position(0);

        ByteBuffer bbNormals = ByteBuffer.allocateDirect(WorldLayoutData.CUBE_NORMALS.length * 4);
        bbNormals.order(ByteOrder.nativeOrder());
        mCubeNormals = bbNormals.asFloatBuffer();
        mCubeNormals.put(WorldLayoutData.CUBE_NORMALS);
